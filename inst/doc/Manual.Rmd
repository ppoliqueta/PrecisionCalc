---
title: "PrecisionCalc - Manual"
author: "Paulo Paiva"
date: "2025-10-10"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{PrecisionCalc  - Manual}
...
It is clear that the best fitted distribution (or least worst) is the normal one. Probably, a non-parametric approach should be used for sample size analysis, as we will see later.
...
What is the sample size for estimate the mean of the polychaete *Lumbrineris curtolobata* in shallow waters of Picinguaba with a precision of at least 10%: 
```{r warning=FALSE}
